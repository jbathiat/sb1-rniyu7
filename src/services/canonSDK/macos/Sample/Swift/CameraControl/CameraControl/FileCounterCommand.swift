...
class FileCounterCommand : Command{
    ...
    func countImages(_ camera : EdsCameraRef, volumeIndex : EdsUInt32, outCount : inout Int, outItem : inout EdsBaseRef?, outImageItems: inout Array<EdsDirectoryItemRef>)->EdsError{
        ...
        for itemIndex in 0..<itemCount{
            ...
            if(itemName == "DCIM" && dirItemInfo.isFolder == 1){
                outItem = dirItem!
                break
            }
